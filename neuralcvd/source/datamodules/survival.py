...
from neuralcvd.source.datamodules.datasets import TabularDataset, DatasetWrapper, BatchedDS
...
class BaseDataModule(pl.LightningDataModule):
    ...
    def get_batched_ds(self, ds):
        if self.return_rank_mat:
            return DeepHitBatchedDS(ds, batch_size=self.batch_size, outdim=self.output_dim, cuts=self.cuts)
        else:
...
class UKBBSurvivalDatamodule(BaseDataModule):
    """
    ...
    :param tabular_filepath: `str`, path to the ukbb_tabular data file.
